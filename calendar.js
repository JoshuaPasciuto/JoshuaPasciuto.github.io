...
setTimeout(function () {
  ...
  function setAll(array1, array2) {
    ...
    if ($.inArray("Exercise Time", array1) >= 0) {
      exercise1Subscribed = 1;
      exercise1Time = array2[$.inArray("Exercise Time", array1)];
  ...
  setTimeout(function () {
    ...
    var calendar = new Calendar(calendarEl, {
      ...
      windowResize: function (view) {
        ...
        height = setCalendarHeight(screenWidth);
    ...
    // Initializes calendar height based on screen width
    var screenWidth = screen.width;
    var height = setCalendarHeight(screenWidth);
